    ...
    var body: some View {
        ...
        LegalSection(number: 10, title: "Okresy przechowywania", icon: "clock.fill") {
            VStack(alignment: .leading, spacing: 6) {
                ...
                LegalBullet("po usunięciu konta dane są usuwane niezwłocznie, nie później niż w ciągu 30 dni (w tym z kopii zapasowych po ich rotacji), z zastrzeżeniem obowiązków prawnych i ochrony roszczeń. Własne przepisy dodane do wspólnego gospodarstwa pozostają w nim (bez powiązania z usuniętym kontem), bo korzystają z nich pozostali domownicy.")
            }
        }
    ...
    var body: some View {
        ...
        LegalSection(number: 5, title: "Asystent AI", icon: "sparkles") {
            VStack(alignment: .leading, spacing: 6) {
                ...
                LegalParagraph("Limity. Liczba wiadomości i zapisanych planów w miesiącu kalendarzowym jest ograniczona na gospodarstwo; aktualne limity pokazuje Aplikacja. Usługodawca może czasowo ograniczyć lub wstrzymać asystenta (np. z powodu kosztów lub awarii dostawcy) — pozostałe funkcje Aplikacji działają wtedy bez zmian.")
                ...
                LegalParagraph("Odpłatność. Asystent jest obecnie bezpłatny w ramach limitów. Usługodawca może w przyszłości wprowadzić płatny plan z wyższymi limitami; warunki, cena i sposób rezygnacji zostaną podane w Aplikacji przed zakupem, a zakup będzie realizowany wyłącznie przez App Store.")
            }
        }
