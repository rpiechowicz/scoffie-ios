...
struct CalendarPlateStrip: View {
    ...
    private func cell(_ item: CalendarPlateItem) -> some View {
        ...
        return VStack(spacing: 8) {
            ...
            VStack(spacing: 2) {
                // Godzina przechodzi kryciem, nie rolowaniem cyfr: przy zmianie
                // dnia w tej samej kolumnie potrafi stanąć „dowolna” zamiast
                // „20:00” i rolowanie robiło z tego zlepek liter.
