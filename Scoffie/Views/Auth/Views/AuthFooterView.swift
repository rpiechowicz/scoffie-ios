    ...
    var body: some View {
        ...
        LegalSection(number: 5, title: "Asystent AI", icon: "sparkles") {
            VStack(alignment: .leading, spacing: 6) {
                ...
                LegalParagraph("Plany. Solo (29,99 zł/mies.), We dwoje (39,99 zł/mies.) i Rodzina (49,99 zł/mies.). Różnią się wyłącznie wielkością miesięcznej puli wiadomości i zapisanych planów — nie liczbą osób w gospodarstwie i nie zakresem funkcji. Aktualne limity każdego planu pokazuje Aplikacja przed zakupem oraz App Store w opisie produktu.")
