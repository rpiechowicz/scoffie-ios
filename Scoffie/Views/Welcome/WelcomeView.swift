...
struct WelcomeView: View {
    ...
    var body: some View {
        // Bez `NavigationStack` i paska nawigacji (24.09.2026): „Wyloguj”
        // stoi w nagłówku kroku (`WelcomeHeader`), a górny brzeg treści gaśnie
        // pod paskiem statusu przez `scScrollEdgeFade` w każdym kroku — tak
        // jak w przewodniku i w arkuszach. Pasek był tu tylko po to, żeby
        // trzymać jedną pigułkę, i spychał treść 132 pt w dół.
        ZStack {
