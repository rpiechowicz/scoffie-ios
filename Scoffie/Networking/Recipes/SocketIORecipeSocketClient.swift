...
final class SocketIORecipeSocketClient: RecipeSocketClient {
    ...
    private let socketQueue = DispatchQueue(label: "app.scoffie.socket.io.serial")
    ...
    private let connectionObserversQueue = DispatchQueue(label: "app.scoffie.socket.connection-observers")
